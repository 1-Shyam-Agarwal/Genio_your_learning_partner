...
const History = ({setShowHistory,learningHistory} : historyPropsType)=>
{
    ...
    return(<div className="absolute inset-0 bg-white/20 z-50 backdrop-blur-sm p-12 overflow-auto">
        ...
        <div className="absolute top-0 right-0 z-100 hover:bg-gray-100 text-black"
            onClick={()=>{setShowHistory(prev=>!prev)}}>
            <RxCross1 className="text-[1.4rem] p-6" style={{ color: 'black' }}/>
        </div>
        ...
        <div className="overflow-x-auto">
            <table className="min-w-full border border-gray-300">
                ...
                {learningHistory.map((lesson) => (
                    ...
                    >
                    <td className="py-2 px-4 border-b flex items-center justify-center text-sm">{lesson.lessonTitle}</td>
